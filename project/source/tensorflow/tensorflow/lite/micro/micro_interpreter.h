...
class MicroInterpreter {
 public:
  ...
  size_t operators_size() const { return operators_size_; }
#else
...
#ifdef MICRO_RUNTIME
  DynamicAgent* GetDynamicAgent(void) { return &dynamic_agent_; }
#endif // MICRO_RUNTIME
 protected:
